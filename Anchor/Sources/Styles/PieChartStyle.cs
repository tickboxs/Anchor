...
namespace Anchor.Sources.Styles
{
    public class PieChartStyle:IChartStyle
    {

        public PieChartDataset Dataset { set; get; }

        public PieChartStyle(PieChartDataset dataset)
        {
            Dataset = dataset;
        }
